...
export function useCanvasDesignerController() {
  ...
  const connections = useCanvasConnections({
    canvasResources,
    setCurrentLayoutSaved,
    setRedoResourcesSnapshotStackTrace: undoRedo.setRedoResourcesSnapshotStackTrace,
  });
  ...
  const dropdown = useInfrastructureDropdown({
    ...
    setUndoResourcesSnapshotStackTrace: undoRedo.setUndoResourcesSnapshotStackTrace,
    setRedoResourcesSnapshotStackTrace: undoRedo.setRedoResourcesSnapshotStackTrace,
  });
